...
const Categories = () => {
    ...
    return (
        <div className='w-[90%] lg:mx-auto my-10 '>
                    ...
                    data?.map(info => {
                        return <Link to={`/categories/${info._id}`}>
                            <div className='w-[30%] h-[40%] mx-auto'>
                                ...
                                <img src={info.img} alt="" srcSet='' title={info.category} className='hidden lg:block border mt-2 shadow-2xl'   data-aos="fade-right" />
                            </div>
                        </Link>
                    })
