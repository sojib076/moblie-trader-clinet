    ...
    return (
        ...
        <>
            <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
                <SwiperSlide className='h-[400px] w-[100%] bg-[#42C8B7]'>
                    <div className='flex justify-between'>
                        <div className='w-[50%]'>
                            ...
                            <button className='btn btn-outline ml-[40%] btn-xs md:btn-md lg:mt-5'> Book Now</button>
                        </div>
                        <div className='w-[45%]'>
                ...
                <SwiperSlide className='h-[300px] w-[100%] bg-[#FF5900]'>
                    <div className='flex justify-between'>
                        <div className='w-[50%] '>
                            <h1 className=' lg:text-3xl text-center text-white'>
